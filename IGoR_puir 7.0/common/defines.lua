...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.0, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.5, -- fraction of ships in the navy that should be cruisers, frigates etc
	AI_TRANSPORT_PROPORTION = 0.5, -- fraction of ships in the navy that should be should be transports
