...
country = {
	...
	CAMPAIGN_EVENT_BASE_TIME = 160, -- Roughly twice per campaign
	CAMPAIGN_EVENT_MIN_TIME = 42 ,-- never more often than 3 weeks between (NOT USED)
	CAMPAIGN_EVENT_STATE_SCALE = -3,	-- every non-colonial state reduces by 3 days (NOT USED)
	CAMPAIGN_DURATION = 12,	-- a campaign lasts these amount of months
	...
	NEWSPAPER_PRINTING_FREQUENCY = 364000, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 364000, -- the max period for news that may be printed. The probability is decreased with time.
	NEWSPAPER_MAX_TENSION = 364000, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately.
...
economy = {
	...
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 500000,
	MAX_LOAN_CAP_FROM_BANKS = 350, -- can loan max % of country tax base from single country
...
military = {
	...
	AI_CAVALRY_PROPORTION = 0.10, -- fraction of brigades that should be cavalry
...
diplomacy = {
	...
	CRISIS_DID_NOT_TAKE_SIDE_PRESTIGE_FACTOR_BASE = -0.0,
	CRISIS_DID_NOT_TAKE_SIDE_PRESTIGE_FACTOR_YEAR = -0.0,
	...
	CRISIS_INTEREST_WAR_EXHAUSTION_LIMIT = 100, -- GPs with WE above this will not get invited to a crisis
...
pops = {
	...
	LARGE_POPULATION_LIMIT = 20000000,
...
ai =
{
	...
	PEACE_BASE_RELUCTANCE = 15, -- AI base stubbornness to refuse peace (always applied)
	...
	PEACE_ALLY_BASE_RELUCTANCE_MULT = 1.5, -- Multiplies PEACE_BASE_RELUCTANCE for allies in a war
	...
	PEACE_ALLY_FORCE_BALANCE_MULT = 1.0, -- Multiplies PEACE_FORCE_BALANCE_FACTOR for allies in a war
